    ...
    <Sidebar {...props}>
      <div className="flex flex-col gap-y-[10px]">
        ...
        <div className="flex flex-col">
          ...
          <h2 className="mt-2 cursor-pointer border-l-2 border-gray-400 py-0.5 pl-4 text-sm hover:!border-amber-500/90 hover:text-amber-500 dark:border-gray-400/20 dark:hover:!border-amber-300/90 dark:hover:text-amber-300">
            Join Meeting
          </h2>
          <div className="h-1.5 w-full border-l-2 border-gray-400 dark:border-gray-400/20" />
          <h2 className="cursor-pointer border-l-2 border-gray-400 py-0.5 pl-4 text-sm hover:!border-amber-500/90 hover:text-amber-500 dark:border-gray-400/20 dark:hover:!border-amber-300/90 dark:hover:text-amber-300">
            Create Meeting
          </h2>
        </div>
      </div>
